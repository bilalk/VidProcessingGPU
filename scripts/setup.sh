...
echo "=== 2. RDP setup ==="
echo "faraz:Faraz@GPU2026" | chpasswd
...
echo "=== 7. Create model directories ==="
...
echo "FULL SETUP SCRIPT DONE — models need to be copied from old server next"
