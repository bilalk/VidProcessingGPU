...
renumber(r'D:\ProjectComfy\reels\gemini-code-1785895658171.json', r'D:\ProjectComfy\reels\r6_w01_manifest.json', 31)
renumber(r'D:\ProjectComfy\reels\gemini-code-1785895723613.json', r'D:\ProjectComfy\reels\r6_w02_manifest.json', 43)
print('DONE')
